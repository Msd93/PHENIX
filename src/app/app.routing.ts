    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'apps', children: [
                ...
                {path: 'panier', loadChildren: () => import('app/modules/admin/apps/panier/panier.module').then(m => m.PanierModule)},
                ...
                {path: 'medias', loadChildren: () => import('app/modules/admin/apps/media/media.module').then(m => m.MediaModule)},
            ]},
